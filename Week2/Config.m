...
highwayMiddlePoint =    round((highwayFrames(2) - highwayFrames(1)) *trainTestSplit);
fallMiddlePoint =       round((fallFrames(2)    - fallFrames(1))    *trainTestSplit);
trafficMiddlePoint =    round((trafficFrames(2) - trafficFrames(1)) *trainTestSplit);
